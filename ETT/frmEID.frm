...
Begin VB.Form frmEID 
   ...
   Begin VB.Label Label5 
      BackStyle       =   0  'Transparent
      Caption         =   "4: Thanks to ""LVolpeButton.ocx"" and                       ""NSDataCombo.ocx""."
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
